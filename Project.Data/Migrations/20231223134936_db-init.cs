    ...
    public partial class dbinit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteStores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavouriteStores_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FavouriteStores_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LiveChats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LiveChats_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreImages_Image_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LiveChatId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_LiveChats_LiveChatId",
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "17442a89-c900-4a6b-ad70-31f26403543a", "AQAAAAIAAYagAAAAEGXwyuDtL9yhZ28MMlQEJR19kTPWxPxkAjSb2qNlb3dwKhAy6G1IIT9rjt+onWvdbw==", "27b0d6a0-dba4-471e-a163-5c1ff5f18a1b", null });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "ConcurrencyStamp", "PasswordHash", "SecurityStamp", "StoreId" },
                values: new object[] { "1333cd33-8b6f-41e4-89f0-eeeb9b5d5701", "AQAAAAIAAYagAAAAEEjSRS5FObQuz4kMDF3VvLv5ivb/KWjxYfdIVfRjJNPcNU2Wk7lj4lGU7pOHIw3bxw==", "cf38cd80-5e9d-43f4-aef3-6d88d07d4adb", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavouriteStores_StoreId",
                table: "FavouriteStores",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_FavouriteStores_UserId",
                table: "FavouriteStores",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveChats_StoreId",
                table: "LiveChats",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveChats_UserId",
                table: "LiveChats",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_LiveChatId",
                table: "Messages",
                column: "LiveChatId");
